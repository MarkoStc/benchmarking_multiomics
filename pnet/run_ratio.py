"""One SLURM array task: fixed P-NET HPs, one feature-ratio value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_pnet_ratio")
    args = p.parse_args()
    ...
    result = model.evaluate_on_feature_ratio(
        ...
        notes="P-NET fixed-HP feature-ratio sweep via Slurm array",
    )
