"""One SLURM array task: fixed P-NET HPs, one omic subset."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_pnet_nomics")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_modalities(
        ...
        feature_selection_spec=fs_spec,
        notes="P-NET fixed-HP n-modalities sweep via Slurm array",
    )
