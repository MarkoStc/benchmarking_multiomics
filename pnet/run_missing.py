"""One SLURM array task: fixed P-NET HPs, one missing-patient fraction."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_pnet_missing")
    args = p.parse_args()
    ...
    result = model.evaluate_on_missing_patients(
        ...
        notes="P-NET fixed-HP missing-patient sweep via Slurm array",
    )
