"""One SLURM array task: fixed LogRegEarlyModel HPs, one missing value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_early_missing")
    args = p.parse_args()
    ...
    result = model.evaluate_on_missing_patients(
        ...
        notes="logreg_early fixed-HP missing-patient sweep via Slurm array",
    )
