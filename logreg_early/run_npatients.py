"""One SLURM array task: fixed LogRegEarlyModel HPs, one npatients value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_early_npatients")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_patients(
        ...
        feature_selection_spec=fs_spec,
        notes="logreg_early fixed-HP n-patients sweep via Slurm array",
    )
