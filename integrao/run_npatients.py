"""One SLURM array task: fixed IntegrAO HPs, one patient-count value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_integrao_npatients")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_patients(
        ...
        feature_selection_spec=fs_spec,
        notes="IntegrAO fixed-HP n-patients sweep via Slurm array",
    )
