"""One SLURM array task: fixed IntegrAO HPs, one missing-patient fraction."""
...
from base import CVSpec, FeatureSelectionSpec
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_integrao_missing")
    args = p.parse_args()
    ...
    result = model.evaluate_on_missing_patients(
        ...
        notes="IntegrAO fixed-HP missing-patient sweep via Slurm array",
    )
    ...
    run_name = (
        ...
        f"__frac{f2tag(args.include_non_intersection_frac)}"
