"""One SLURM array task: fixed PCALogRegModel HPs, one ratio value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_pca_logreg_ratio")
    args = p.parse_args()
    ...
    result = model.evaluate_on_feature_ratio(
        ...
        notes="pca fixed-HP feature-ratio sweep via Slurm array",
    )
