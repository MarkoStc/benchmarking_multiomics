"""PCALogRegModel one-omic-at-a-time feature sweep (README 9.3): target omic at
...
def main() -> None:
    ...
    result = model.evaluate_on_feature_ratio_one_omic(
        ...
        notes="pca one-omic-at-a-time feature sweep (README 9.3) via Slurm array")

    run_name = (f"pca__nc{args.n_components}__C{f2tag(args.downstream_c)}__omic{args.target_omic}"
