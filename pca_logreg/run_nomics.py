"""One SLURM array task: fixed PCALogRegModel HPs, one nomics value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_pca_logreg_nomics")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_modalities(
        ...
        feature_selection_spec=fs_spec,
        notes="pca fixed-HP n-modalities sweep via Slurm array",
    )
