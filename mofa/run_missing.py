"""One SLURM array task: fixed MOFA HPs, one missing-patient fraction."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_mofa_missing")
    args = p.parse_args()
    ...
    result = model.evaluate_on_missing_patients(
        ...
        notes="MOFA fixed-HP missing-patient sweep via Slurm array",
    )
