"""One SLURM array task: fixed MOFA HPs, one omic combination."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_mofa_nomics")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_modalities(
        ...
        feature_selection_spec=fs_spec,
        notes="MOFA fixed-HP n-modalities sweep via Slurm array",
    )
