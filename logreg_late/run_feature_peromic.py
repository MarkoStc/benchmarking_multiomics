"""LogRegLateModel one-omic-at-a-time feature sweep (README 9.3): target omic at
...
from sk_bench import LogRegLateModel as Model, dump_fold_artifacts  # noqa: E402
...
def main() -> None:
    ...
    result = model.evaluate_on_feature_ratio_one_omic(
        ...
        notes="logreg_late one-omic-at-a-time feature sweep (README 9.3) via Slurm array")

    run_name = (f"logreg_late__C{f2tag(args.downstream_c)}__omic{args.target_omic}"
