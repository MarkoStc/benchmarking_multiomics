"""One SLURM array task: fixed LogRegLateModel HPs, one missing value."""
...
from sk_bench import LogRegLateModel as Model, dump_fold_artifacts
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_late_missing")
    args = p.parse_args()
    ...
    result = model.evaluate_on_missing_patients(
        ...
        notes="logreg_late fixed-HP missing-patient sweep via Slurm array",
    )
