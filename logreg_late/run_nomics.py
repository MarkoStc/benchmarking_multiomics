"""One SLURM array task: fixed LogRegLateModel HPs, one nomics value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_late_nomics")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_modalities(
        ...
        feature_selection_spec=fs_spec,
        notes="logreg_late fixed-HP n-modalities sweep via Slurm array",
    )
