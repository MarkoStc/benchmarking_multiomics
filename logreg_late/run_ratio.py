"""One SLURM array task: fixed LogRegLateModel HPs, one ratio value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_late_ratio")
    args = p.parse_args()
    ...
    result = model.evaluate_on_feature_ratio(
        ...
        notes="logreg_late fixed-HP feature-ratio sweep via Slurm array",
    )
