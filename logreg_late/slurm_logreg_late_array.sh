#!/bin/bash -l
#SBATCH --job-name=logreg_late-array
...
# Usage:
#   sbatch --array=1-N slurm_logreg_late_array.sh <experiments_file.txt>

set -euo pipefail

cd /work/scitas-share/FellayMultiOmic/code/full-test-pipeline/logreg_late
