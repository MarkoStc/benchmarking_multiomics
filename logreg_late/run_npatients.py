"""One SLURM array task: fixed LogRegLateModel HPs, one npatients value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_logreg_late_npatients")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_patients(
        ...
        feature_selection_spec=fs_spec,
        notes="logreg_late fixed-HP n-patients sweep via Slurm array",
    )
