"""One SLURM array task: fixed SVMEarlyModel HPs, one ratio value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_svm_early_ratio")
    args = p.parse_args()
    ...
    result = model.evaluate_on_feature_ratio(
        ...
        notes="svm_early fixed-HP feature-ratio sweep via Slurm array",
    )
