#!/bin/bash -l
#SBATCH --job-name=svm_early-array
...
# Usage:
#   sbatch --array=1-N slurm_svm_early_array.sh <experiments_file.txt>

set -euo pipefail

cd /work/scitas-share/FellayMultiOmic/code/full-test-pipeline/svm_early
