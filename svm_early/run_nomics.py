"""One SLURM array task: fixed SVMEarlyModel HPs, one nomics value."""
...
def main() -> None:
    ...
    p.add_argument("--output-root", default="results_svm_early_nomics")
    args = p.parse_args()
    ...
    result = model.evaluate_on_n_modalities(
        ...
        feature_selection_spec=fs_spec,
        notes="svm_early fixed-HP n-modalities sweep via Slurm array",
    )
